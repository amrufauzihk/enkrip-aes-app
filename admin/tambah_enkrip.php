...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <form class="w3-container" action="enkripsi_proses.php" enctype="multipart/form-data" method="POST">
        ...
        <input class="w3-input" name="dokumen" type="file" accept="application/pdf">
